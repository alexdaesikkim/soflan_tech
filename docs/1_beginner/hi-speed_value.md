# Hi-Speed Value
This section is for the Hi-Speed value that is displayed in the gear itself. For the sake of rest of the material on this site, it is HIGHLY recommended (if not mandatory) to have a basic grasp of what this number is.

## What is this Hi-Speed Value?
The Hi-Speed Value is the number that is displayed at the bottom of the gear as 'HI-SPEED', and is located next to the 'SCORE'.

With Normal Hi-Speed and Floating Hi-Speed, this value changes based on your total WN and GN. Classic Hi-Speed is different, as the value set for the Classic Hi-Speed corresponds to the Hi-Speed Value.
...
Using Classic Hi-Speed, the GN value halves if you double the Classic Hi-Speed value, and the GN doubles if you halve the Classic Hi-Speed value. Similarly, using FHS, if you double your GN value, your Hi-Speed Value will halve and vice versa (halve GN = double Hi-Speed Value).